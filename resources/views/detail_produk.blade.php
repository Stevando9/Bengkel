        ...
        <div class="container mx-auto">
            <div class="bg-second text-white rounded-md w-1/2 p-6 rounded-b-md mx-auto">
                ...
                <div class="flex mt-6 space-x-2 justify-between">
                    ...
                    <a href="{{ route('pembayaran.single', ['kode_produk'=>$produk['kode_produk'],'jumlah'=>1,'deliveryMethod'=>'radioKirim']) }}"><button class="w-32 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold py-2 rounded-lg">Beli</button></a>
                </div>
            </div>
        </div>
    </section> 
