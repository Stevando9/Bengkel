...
<body class="bg-black">
   ...
   <section class="pt-36 pb-16">
        <div class="container mx-auto px-4">
            <div class="bg-second text-black p-6 rounded-lg shadow-md w-full lg:w-1/3 mx-auto">
                <!-- Icon & Title -->
                <div class="text-center mb-6">
                    <h2 class="text-2xl font-bold text-white">ALAMAT</h2>
                </div>

                <!-- Form -->
                <form action="/submit-alamat" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label for="kelurahan" class="block text-white font-medium mb-2">Kelurahan</label>
                        <input 
                            type="text" 
                            id="kelurahan" 
                            name="kelurahan" 
                            class="w-full px-4 py-2 rounded-lg bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-400" 
                            placeholder="Masukkan Kelurahan" 
                            required>
                    </div>
                    <div class="mb-4">
                        <label for="kecamatan" class="block text-white font-medium mb-2">Kecamatan</label>
                        <input 
                            type="text" 
                            id="kecamatan" 
                            name="kecamatan" 
                            class="w-full px-4 py-2 rounded-lg bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400" 
                            placeholder="Masukkan Kecamatan" 
                            required>
                    </div>
                    <div class="mb-4">
                        <label for="provinsi" class="block text-white font-medium mb-2">Provinsi</label>
                        <input 
                            type="text" 
                            id="provinsi" 
                            name="provinsi" 
                    ...
                    <div class="mb-6">
                        <label for="detail" class="block text-white font-medium mb-2">Detail Alamat</label>
                        <textarea 
                            id="detail" 
                            name="detail" 
                            rows="4" 
                    ...
                    <button 
                        ...
                        class="bg-red-500 text-white font-medium py-2 px-4 rounded-lg hover:bg-red-600 transition duration-200">
                        Batal
                    </button>
                    ...
                    <button 
                        type="submit" 
                        class="bg-blue-500 text-white font-medium py-2 px-4 rounded-lg hover:bg-blue-600 transition duration-200">
                        Kirim
                    </button>
                </div>
                </form>
